...
inflated only for tight close-offload decisions.  In an expanded LTE evaluation
over three seeds, two runs, and three inter-site spacings, the adaptive wakeup
...
forecast, selective overlap-gated margins recover all 16/16 feasible rows with
16.744\% mean safe energy saving.  These preliminary results suggest
...
rows unsafe.  The selective overlap margin recovers all 16 feasible rows while
retaining high energy saving.
...
The selective result is the strongest current evidence for the paper.  It
