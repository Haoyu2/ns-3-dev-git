...
#ifndef My_POINT_TO_POINT_DUMBBELL_HELPER_H
#define My_POINT_TO_POINT_DUMBBELL_HELPER_H
 ...
 * with p2p links
 */
class MyPointToPointDumbbellHelper
{
  public:
    /**
     * Create a MyPointToPointDumbbellHelper in order to easily create
     ...
     *                         the bottleneck link
     */
    MyPointToPointDumbbellHelper(uint32_t nLeftLeaf,
    ...
    ~MyPointToPointDumbbellHelper();

  public:

    QueueDiscContainer GetNeckQueueContainer() const;
  ...
  private:
    ...
    TrafficControlHelper m_neckQueueHelper;
    TrafficControlHelper m_leafQueueHelper;
    QueueDiscContainer m_neckQueueContainer;
};
